...
| Level | Count | Meaning |
|---|---|---|
| **simulated** | 39 | The engine implements it and tests assert the behaviour. |
...
| **ignored** | 15 | Should be simulated, is not yet, and names the issue tracking it. Every one of these is a known wrong answer. |
